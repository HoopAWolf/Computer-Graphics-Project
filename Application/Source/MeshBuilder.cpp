...
Mesh* MeshBuilder::GenerateQuad2(const std::string &meshName, Color color, float lengthX, float lengthY)
{
	...
	v.pos.Set(0.f, 0.f, 0.f);	v.color = color; v.normal.Set(0.f, 0.5f, 0.f); v.texCoord.Set(0, 1); vertex_buffer_data.push_back(v);
	v.pos.Set(1.f, 0.f, 0.f);	v.color = color; v.normal.Set(0.f, 0.5f, 0.f); v.texCoord.Set(0, 0); vertex_buffer_data.push_back(v);
	v.pos.Set(0.f, 1.f, 0.f);	v.color = color; v.normal.Set(0.f, 0.5f, 0.f); v.texCoord.Set(1, 1); vertex_buffer_data.push_back(v);

	v.pos.Set(1.f, 1.f, 0.f);	v.color = color; v.normal.Set(0.f, 0.5f, 0.f); v.texCoord.Set(1, 0); vertex_buffer_data.push_back(v);
...
Mesh* MeshBuilder::GenerateTRI(const std::string &meshName, Color color, float lengthX, float lengthY)
{
	std::vector<Vertex> vertex_buffer_data;
	std::vector<GLuint> index_buffer_data;
	Vertex v;
	...
	v.pos.Set(0.f, 0.f, 0.f);	v.color = color; v.normal.Set(0.f, 0.5f, 0.f); v.texCoord.Set(0, 1); vertex_buffer_data.push_back(v);
	v.pos.Set(1.f, 0.5f, 0.f);	v.color = color; v.normal.Set(0.f, 0.5f, 0.f); v.texCoord.Set(0, 0); vertex_buffer_data.push_back(v);
	v.pos.Set(0.f, 1.f, 0.f);	v.color = color; v.normal.Set(0.f, 0.5f, 0.f); v.texCoord.Set(1, 1); vertex_buffer_data.push_back(v);
